...
function loadData() {
    d3.csv("us_norm.csv", (d) => {
        ...
        var spirit = [factors[2], factors[17]];
        console.log(spirit);
        multiLineChart(spirit, "#chart1");

        var depression = [factors[2], factors[15]];
        var beer = [factors[2], factors[18]];
        var mental = [factors[2], factors[9]];
        multiLineChart(beer, "#chart2");
        multiLineChart(depression, "#chart3");
        multiLineChart(mental, "#chart4");
    });
}
